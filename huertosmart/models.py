...
class Huerto(models.Model):
    ...
    # Si se borra el usuario, se borran también sus huertos (modelo Huerto)
...
class Siembra(models.Model):
    ...
    # No deja borrar un cultivo del catálogo si tiene siembras (modelo Siembra)
...
class Diagnostico(models.Model):
    ...
    # Si se borra la siembra, el diagnóstico se queda pero sin ella (modelo Diagnostico)
